...
const Content = ({ align = 'left', width = '48', contentClasses = 'py-1 bg-bnb-light-blue text-white', children }: PropsWithChildren<{ align?: 'left'|'right', width?: '48', contentClasses?: string }>) => {
